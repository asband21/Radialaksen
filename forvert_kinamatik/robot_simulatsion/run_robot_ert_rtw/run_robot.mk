###########################################################################
## Makefile generated for component 'run_robot'. 
## 
## Makefile     : run_robot.mk
## Generated on : Thu Apr 07 09:34:33 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/run_robot.elf
...
SLIB_PATH        = C:/Users/rlk/DOCUME~1/MATLAB/R2021b/ARDUIN~1/ARDUIN~1/FASTER~1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/run_robot.elf
...
DEFINES_STANDARD = -DMODEL=run_robot -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_ServoWriteRead.o xcp_ext_mode.o run_robot.o run_robot_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/run_robot_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/run_robot_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/run_robot_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/run_robot_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


run_robot.o : $(START_DIR)/run_robot_ert_rtw/run_robot.c
	$(CC) $(CFLAGS) -o "$@" "$<"


run_robot_data.o : $(START_DIR)/run_robot_ert_rtw/run_robot_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
